...
const mockApps = [
  { slug: 'coming-soon', name: 'your first app', status: 'draft', icon: '🚀', description: 'describe it, we build it' },
];
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-gray-100 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* profile icon — will connect to supabase auth */}
            <button className="w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-gray-200 transition-colors" aria-label="profile menu">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mockApps.map((app) => (
              ...
              >
                ...
                <p className="mt-1 text-gray-500 text-sm">{app.description}</p>
                <div className="mt-4">
